...
public class FreightFrenzyDeterminationPipeline extends OpenCvPipeline {
    ...
    private Point regionOnePointA;
    private Point regionOnePointB;
    private Point regionTwoPointA;
    private Point regionTwoPointB;
    private Point regionThreePointA;
    private Point regionThreePointB;
    ...
    public void init(Mat firstFrame) {
        setRectOne(38, 80, 33, 34);
        setRectTwo(140, 93, 29, 32);
        setRectThree(232, 100, 35,35);
    ...
    public Mat processFrame(Mat input) {
        ...
        avg1 = (int) getColorDifference(Core.mean(region1_Cb), yellowColor);
        avg2 = (int) getColorDifference(Core.mean(region2_Cb), yellowColor);
        avg3 = (int) getColorDifference(Core.mean(region3_Cb), yellowColor);
