...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, "lm1");
        leftRear = hardwareMap.get(DcMotorEx.class, "lm2");
        rightRear = hardwareMap.get(DcMotorEx.class, "rm2");
        rightFront = hardwareMap.get(DcMotorEx.class, "rm1");
