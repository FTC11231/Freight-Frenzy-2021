...
public class SampleTankDrive extends TankDrive {
    ...
    public SampleTankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx leftFront = hardwareMap.get(DcMotorEx.class, "lm1");
        DcMotorEx leftRear = hardwareMap.get(DcMotorEx.class, "lm2");
        DcMotorEx rightRear = hardwareMap.get(DcMotorEx.class, "rm2");
        DcMotorEx rightFront = hardwareMap.get(DcMotorEx.class, "rm1");
